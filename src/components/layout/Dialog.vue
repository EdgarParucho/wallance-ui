      ...
      <Dialog as="div" class="relative z-10" @close="$emit('close-form')">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
          <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <DialogPanel class="overflow-hidden rounded-lg shadow-xl sm:my-8 pt-8 bg-stone-200 dark:bg-stone-900 w-96 2xl:w-1/4">
...
const props = defineProps(['form-is-open', 'icon', 'title', 'subtitle'])
